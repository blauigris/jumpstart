...
__all__ = [
    ...
    "resnet101_conv",
    "resnet152_conv",
    "resnext50_32x4d_conv",
    "resnext101_32x8d_conv",
    "resnext101_64x4d_conv",
    "wide_resnet50_2_conv",
    "wide_resnet101_2_conv",
]
...
class ResNet(nn.Module):
    def __init__(
        ...
        if self.width_multiplier == 2:
            ...
            widths = compute_widths_from_multiplier(64, self.width_multiplier)
...
def resnet18_conv(*, weights: Optional[ResNet18_Weights] = None, progress: bool = True, **kwargs: Any) -> ResNet:
...
def resnet34_conv(*, weights: Optional[ResNet34_Weights] = None, progress: bool = True, **kwargs: Any) -> ResNet:
...
def resnet50_conv(*, weights: Optional[ResNet50_Weights] = None, progress: bool = True, **kwargs: Any) -> ResNet:
...
def resnet101_conv(*, weights: Optional[ResNet101_Weights] = None, progress: bool = True, **kwargs: Any) -> ResNet:
...
def resnet152_conv(*, weights: Optional[ResNet152_Weights] = None, progress: bool = True, **kwargs: Any) -> ResNet:
...
def compute_widths_from_multiplier(base_width=64, width_multiplier=2, num_layers=4):
    widths = []
    current_width = base_width
    for _ in range(num_layers):
        widths.append(current_width)
        current_width = int(current_width * width_multiplier)
